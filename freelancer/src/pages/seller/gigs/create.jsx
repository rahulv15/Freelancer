        ...
        <div className="flex flex-col gap-5 mt-10">
            <div className="grid grid-cols-2 gap-11">
                ...
                <div>
                    ...
                    <select name="category" id="category" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-4" onChange={handleChange}>
                        {categories.map(({ name }) => (
